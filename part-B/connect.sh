...
# OVS rules for s1
$ofctl add-flow s1 \
    dl_src=0A:00:0A:01:00:02, dl_dst=0A:00:04:01:00:01, actions=output:2
...
# OVS rules for s2
$ofctl add-flow s2 \
    dl_src=0A:00:0A:FE:00:02, dl_dst=b0:b0:b0:b0:b0:b0, actions=output:2

$ofctl add-flow s2 \
    dl_src=0A:00:01:01:00:01, dl_dst=0A:0A:00:0E:FE:00:02, actions=output:1
