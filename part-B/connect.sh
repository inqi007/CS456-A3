...
$ofctl add-flow r1 \
    ...
    # actions=mod_dl_src:0A:00:0E:FE:00:02,mod_dl_dst:b0:b0:b0:b0:b0:b0,output=all,in_port
    # mod_dl_src=0A:00:0E:FE:00:02, mod_dl_dst=b0:b0:b0:b0:b0:b0, actions=1,2
...
$ofctl add-flow r1 \
    ...
    # actions=mod_dl_src:0A:00:04:01:00:01,mod_dl_dst:aa:aa:aa:aa:aa:aa,output=all,in_port
    # mod_dl_src=0A:00:04:01:00:01, mod_dl_dst=aa:aa:aa:aa:aa:aa, actions=1,2
